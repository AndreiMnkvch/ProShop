...
import { Col, Row, Image, ListGroup, Form, Button, Card, ListGroupItem } from 'react-bootstrap'
            ...
            (item) => (
                ...
                <Row>
                    ...
                    <Form.Control
                        as="select"
                        value={item.qty}
                        onChange={(e) => dispatch(addToCart({productId: item.product, qty: Number(e.target.value)}))}
                        >
                        {
